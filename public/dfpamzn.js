    ...
    try {
      ...
      googletag.cmd.push(() => {
        e.forEach((e, a) => {
          ...
          platform = e?.getAttribute('platform');
          t[a] = d?.includes('_Across_Interstitial')
            ? googletag
                .defineOutOfPageSlot(
                  d,
        ...
        platform && googletag.pubads().setTargeting('platform', [platform]);
        ...
        //     if (
        //       e &&
        //       !(ptype == 'article' && p?.includes('_Sticky')) &&
        //       !p?.includes('_LogoBand') &&
        //       platform != 'desktop' || (p?.includes('_ShortVideos_'))
        //     ) {
